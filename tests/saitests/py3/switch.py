...
def sai_thrift_read_pg_counters(client, target, port_id):
    pg_cntr_ids = [
    ...
    pg_ids = []
    port_attrs = client.sai_thrift_get_port_attribute(port_list[target][port_id])
...
def sai_thrift_read_pg_occupancy(client, target, port_id):
    pg_cntr_ids = [
